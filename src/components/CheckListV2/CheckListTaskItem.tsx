// components/checklist/ChecklistTaskItem.tsx
    ...
    <Box sx={{ mb: 1.5 }}>
      <Box
        sx={{
          ...
          gap: 1,
          cursor: task.noteField ? "default" : "pointer",
        }}
        onClick={task.noteField ? undefined : onToggle}>
        {/* Checkbox - Red tick when checked */}
        <Box
          sx={{
            width: 18,
            height: 18,
