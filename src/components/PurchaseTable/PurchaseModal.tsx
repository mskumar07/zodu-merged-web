...
const PurchaseModal: React.FC<PurchaseModalProps> = ({
  ...
  const totalSellingPrice =
    ...
    0;
  const totalPrice =
    data.items?.reduce((sum, item) => sum + item.total_price, 0).toFixed(2) || 0;
  const balanceAmount =
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="lg" fullWidth>
      ...
      >
        ...
        <Box display="grid" gridTemplateColumns="repeat(4, 1fr)" gap={3}>
          ...
          <Box>
            ...
            <Typography
              fontWeight={600}
              color={balanceAmount > 0 ? "red" : "success"}
            >
      ...
      <DialogContent
        sx={{
          height: "600px", //adjusted the height zodu-hot fix
                    ...
                    >
                      <TableCell>
                        <Typography variant="body2">
                          ...
                          {formatDateTime(payment.payment_date)} {/*Z-i34 */}
                        </Typography>
                      </TableCell>
                      <TableCell>
                        <Typography variant="body2">
